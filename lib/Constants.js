...
const Labels = {
    ...
    SEARCH_FOR_LOCATION: 'Search for new location.',
    NO_RESULTS: 'No results found.',
    RETRIEVING_LOCATION: 'Finding location...',
    NOT_FOUND: 'Looks like an establishment matching that name does not have any specials in our records.'
}
